...
var config = {
  ...
  scope: 'playlist-read-private playlist-modify-public playlist-modify-private user-follow-modify user-follow-read user-library-read user-library-modify user-read-email user-read-currently-playing'
...
var songUpdateForm = __webpack_require__(42);

var onGetAllSongs = function onGetAllSongs() {
  api.getAllSongs().then(ui.getAllSongsSuccess).catch(ui.getAllSongsFailure);
};
...
var onCreateSong = function onCreateSong(event) {
  ...
  if (data.song.title === '' || data.song.artist === '') {
    ...
    if ($('#main-left-container').html() === '') {
      api.getAllSongs().then(ui.getAllSongsSuccess).catch(ui.getAllSongsFailure).then(function (e) {
        return api.createSong(data);
      }).then(ui.createSongSuccess).catch(ui.createSongFailure);
    } else {
      api.createSong(data).then(ui.createSongSuccess).catch(ui.createSongFailure);
    }
  }
};

var editSetup = function editSetup(event) {
  event.preventDefault();
...
var deleteSetup = function deleteSetup(event) {
  event.preventDefault();
  if (store.old) {
    if (store.old.id) {
      cancelEdit();
...
var onDeleteSong = function onDeleteSong(event) {
  ...
  api.deleteSong(songId).then(ui.deleteSongSuccess).catch(ui.deleteSongFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"row vision-test\" id=\"row-"
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n"
    + ((stack1 = container.invokePartial(__webpack_require__(11),depth0,{"name":"song-row","hash":{"song":(depth0 != null ? depth0.song : depth0)},"data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- <form id=\"form-"
    ...
    + "\" class=\"edit-song-form\"> -->\n  <div class=\"col-xs-5\" id=\"title-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.title : stack1), depth0))
    + "</div>\n  <div class=\"col-xs-4\" id=\"artist-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.artist : stack1), depth0))
    + "</div>\n  <div class=\"col-xs-3\" id=\"button-box-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
...
var songs = __webpack_require__(9);
...
var setAPIOrigin = function setAPIOrigin(location, config) {
  ...
  if (search.environment === 'development' || location.hostname === 'localhost' && search.environment !== 'production') {
    ...
    config.frontOrigin = 'http://localhost:7165';
    ...
    config.frontOrigin = config.frontOrigins.production;
  }
};
...
var songsEvents = __webpack_require__(9);

var config = __webpack_require__(4);
var store = __webpack_require__(3);

var firstVisitButton = __webpack_require__(43);
  ...
  if (store.user) {
    if (store.user.token) {
      ...
      if (urlParams.error) {
        ...
        api.getAccessToken(urlParams).then(ui.getAccessTokenSuccess).then(ui.getAccessTokenFailure);
      } else {
        var buttonURL = 'https://accounts.spotify.com/authorize/';
        ...
        var newButton = firstVisitButton({ spec: buttonURL });
...
var checkForLogin = function checkForLogin() {
  var objectToVerify = localStorage.getItem('savedUser');
  if (objectToVerify) {
    // console.log('objectToVerify', objectToVerify)
    var verifyAgain = JSON.parse(objectToVerify);
...
var onSignIn = function onSignIn(event) {
  ...
  // console.log(data)
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(songsEvents.onGetAllSongs).catch(ui.signInFailure);
};
...
module.exports = {
  addHandlers: addHandlers,
  checkForCodeInURL: checkForCodeInURL,
...
var getAccessToken = function getAccessToken(urlParams) {
...
var keepGettingThatAccessToken = function keepGettingThatAccessToken(xData) {
  return $.ajax({
...
module.exports = {
  ...
  signOut: signOut,
  keepGettingThatAccessToken: keepGettingThatAccessToken
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var SignedOut = __webpack_require__(20);
var SignedIn = __webpack_require__(37);
var SignedInButtons = __webpack_require__(38);

var getAccessTokenSuccess = function getAccessTokenSuccess(data) {
...
var getAccessTokenFailure = function getAccessTokenFailure() {
  console.error();
};

var keepGettingThatAccessTokenSuccess = function keepGettingThatAccessTokenSuccess(data) {
...
var refreshLoginDiv = function refreshLoginDiv() {
  if (store.user) {
    if (store.user.token) {
      var loggedIn = SignedIn();
      $('#login-div').html(loggedIn);
      var makeButtons = SignedInButtons();
      $('#button-div').html(makeButtons);
      return 4;
    }
  }
  var loggedOut = SignedOut();
...
module.exports = {
  ...
  refreshLoginDiv: refreshLoginDiv,
  keepGettingThatAccessTokenSuccess: keepGettingThatAccessTokenSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"row\">\n  <!-- <a class=\"nav-item nav-link active\" href=\"#\">Home <span class=\"sr-only\">(current)</span></a> -->\n  <form id=\"sign-in-form\">\n    <input name=\"credentials[email]\" type=\"text\" placeholder=\"Username\" id=\"sign-in-email\">\n    <input name=\"credentials[password]\" type=\"password\" placeholder=\"Password\" id=\"sign-in-password\">\n    <input type=\"submit\" class=\"btn btn-primary\" value=\"Sign In\">\n  </form>\n  <!-- Button trigger modal -->\n  <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#createAccount\" id=\"createAccountButton\">\n    Create New Account\n  </button>\n</div>\n<div class=\"modal fade\" id=\"createAccount\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <form id=\"sign-up-form\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" id=\"close-create-account-button\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <fieldset>\n            <legend>Create an Account</legend>\n            <input name=\"credentials[email]\" type=\"text\" placeholder=\"New Username\" id=\"new-user-email\">\n            <input name=\"credentials[password]\" type=\"password\" placeholder=\"Password\" id=\"new-user-password\">\n            <input name=\"credentials[password_confirmation]\" type=\"password\" placeholder=\"Confirm Password\" id=\"new-user-password-confirm\">\n            <!-- <input type=\"submit\" class=\"btn btn-primary\" name=\"submit\" value=\"Save Changes\"> -->\n          </fieldset>\n          <p style=\"color:black;\" id=\"create-account-message-box\"></p>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Close</button>\n          <button type=\"submit\" class=\"btn btn-primary\">Create Account</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"row\">\n  <!-- <a class=\"nav-item nav-link active\" href=\"#\">Home <span class=\"sr-only\">(current)</span></a> -->\n  <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#changePassword\" id=\"changePasswordButton\">\n    Change Password\n  </button>\n  <button type=\"submit\" class=\"btn btn-primary\" id=\"sign-out\">\n    Sign Out\n  </button>\n</div>\n<div class=\"modal fade\" id=\"changePassword\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <form id=\"change-password\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" id=\"close-change-password\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <fieldset>\n            <legend>Change Password</legend>\n            <input name=\"passwords[old]\" type=\"password\" placeholder=\"Old Password\" id=\"change-old-password-input\">\n            <input name=\"passwords[new]\" type=\"password\" placeholder=\"New Password\" id=\"change-new-password-input\">\n            <!-- <input type=\"submit\" class=\"btn btn-primary\" name=\"submit\" value=\"Save Changes\"> -->\n          </fieldset>\n          <p style=\"color:black;\" id=\"change-password-status-message\"></p>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Close</button>\n          <button type=\"submit\" class=\"btn btn-primary\">Change Password</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div style=\"float:right\">\n  <button type=\"submit\" class=\"btn btn-primary\" id=\"get-songs\">\n    Get Songs\n  </button>\n  <!-- <button type=\"submit\" class=\"btn btn-primary\" id=\"clear-songs\">\n    Clear Songs\n  </button> -->\n  <form id=\"create-song\">\n    <input name=\"song[title]\" type=\"text\" placeholder=\"Title\" id=\"create-song-title\">\n    <input name=\"song[artist]\" type=\"text\" placeholder=\"Artist\" id=\"create-song-artist\">\n    <input type=\"submit\" class=\"btn btn-primary\" value=\"Create Song\">\n  </form>\n</div>\n";
},"useData":true});
...
var editSong = function editSong(data) {
...
var songsTable = __webpack_require__(41);
var songRow = __webpack_require__(11);
var newSongAddRow = __webpack_require__(10);
...
var getAllSongsSuccess = function getAllSongsSuccess(data) {
  ...
  var songsForDiv = songsTable({ songs: store.songs });
  $('#main-left-container').html(songsForDiv);
};

var getAllSongsFailure = function getAllSongsFailure(err) {
  console.log(err);
...
var createSongSuccess = function createSongSuccess(data) {
  ...
  var newRow = newSongAddRow({ song: data.song });
...
var editSongSuccess = function editSongSuccess(data) {
  // console.log('data from updated song:\n', data)
  $('#welcome-div').text('You updated a song!'); // See console log for details...
  var replacementRow = songRow({ song: data.song });
  $('#row-' + data.song.id).html(replacementRow);
  if (store.songs) {
    var oldSong = store.songs.find(function (e) {
      return e === store.old.id;
    });
    var indexOfOldSong = store.songs.indexOf(oldSong);
...
var editSongFailure = function editSongFailure() {
  console.error();
};
...
var deleteSongSuccess = function deleteSongSuccess() {
  ...
  var rowToDelete = document.getElementById('row-' + store.oldDelete.id);
...
module.exports = {
  ...
  editSongSuccess: editSongSuccess,
  editSongFailure: editSongFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = container.invokePartial(__webpack_require__(10),depth0,{"name":"new-song-add-row","hash":{"song":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class=\"row\">\n  <div class=\"col-xs-5\" id=\"songs-table-header-1\">Title</div>\n  <div class=\"col-xs-5\" id=\"songs-table-header-2\">Artist</div>\n  <div class=\"col-xs-2\" id=\"songs-table-header-3\">Edit</div>\n</div>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"edit-song-form\">\n  <div class=\"col-xs-5\">\n    <input type=\"text\" name=\"song[title]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.Title : stack1), depth0))
    + "\" id=\"input-title-replace-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  </div>\n  <div class=\"col-xs-4\">\n    <input type=\"text\" name=\"song[artist]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.Artist : stack1), depth0))
    + "\" id=\"input-artist-replace-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <input type=\"hidden\" name=\"song[id]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.song : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  </div>\n  <div class=\"col-xs-3\">\n    <!-- <input type=\"submit\" value=\"Submit\" class=\"confirm-edit-button\" style=\"float:right;\"> -->\n    <button type=\"submit\" class=\"confirm-edit-button\">Submit</button>\n    <button class=\"cancel-edit-button\">Cancel</button>\n  </div>\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a href=\""
    ...
    + "\">Click Here to Connect App to Spotify</a>\n";
},"useData":true});
